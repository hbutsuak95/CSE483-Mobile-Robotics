function [fRANSAC, Inliers] = estimateFundamentalMatrixRANSAC(matchedPoints1, matchedPoints2, numIter)    
    x1 = matchedPoints1;
    x2 = matchedPoints2;
...
err = sum((x2 .* (fRANSAC * x1')'),2);[Y,I]  = sort(abs(err),'ascend');
inliers1 = x1(I(1:200),:);
inliers2 = x2(I(1:200),:);
